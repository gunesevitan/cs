 ...
 * Servers are large computers that allow various users to access 
 ...
 * Embedded Computers are single task computers that perform a single 
 ...
 * Personal Computers are the sophisticated version of smartphones. 
 * They are faster than smartphones, have higher computer power, and they 
 * are single user computers.
 
 * d. Super Computers
 
 * A super computer is a computer with high-level computational 
