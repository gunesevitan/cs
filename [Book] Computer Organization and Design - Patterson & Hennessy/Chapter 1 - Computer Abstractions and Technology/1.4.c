 ...
 * a. 1280 x 1024 pixels and 3 bytes (one for red,one for green and 
 * one for blue) so the size of the buffer to store a frame is: 
 * 1280 * 1024 * 3 Bytes = 3 932 160 Bytes (3.9 MB)
 
 * b. 100 Mbit/s = 12.5 MB/s ... 3.9 MB / 12.5 MB/s = 0.312 s
