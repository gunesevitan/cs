...
# 1. What do we do to a Python statement that is immediately after an if statement to
...
# 6. What is the Python reserved word that we use in two-way if tests to indicate the block of
