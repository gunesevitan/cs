...
# 3.
# At the moment of creation of a new object, Python looks at the _________ definition
...
# 6.
# What is the syntax to look up the fullname attribute in an object
# stored in the variable colleen?
...
# 7.
# Which of these statements is used to indicate that class A
# will inherit all the features of class B?
...
# 10.
# What does the Python dir() function show when we pass an object
